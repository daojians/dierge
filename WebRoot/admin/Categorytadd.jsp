  ...
  <body>
	...
	layui.use('element', function(){
      ...
      <ul class="layui-nav layui-nav-tree" lay-filter="test">
		...
		<div>
			<form class="layui-form" action="../Categoryservlet" method="post">
			  <div class="layui-form-item">
			    <label class="layui-form-label">输入新信息</label>
			    <div class="layui-input-block">
			      <input type="text" name="title" required  lay-verify="required" placeholder="请输入课程" autocomplete="off" class="layui-input">
			    </div>
			  </div>
			      <div class="layui-form-item">
			    <div class="layui-input-block">
			      <input class="layui-btn" type="submit" lay-submit lay-filter="formDemo" value="修改">
			    </div>
			  </div>
			</form>
		</div>
